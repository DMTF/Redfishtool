...
class RfSessionServiceMain():
    ...
    def displayOperations(self,rft):
        ...
        print("     patch {A: B,C: D,...}     -- patch the sessionService w/ json-formated {prop: value...} ")
        ...
        print("     login <user> <passwd>     -- sessionLogin.  post to Sessions collection to create a session")
        print("     logout <sessionId>        -- logout or delete the session identified by <SessionId>")
...
class RfSessionServiceOperations():
    ...
    def examples(self,sc,op,rft,cmdTop=False,prop=None):
        ...
        print(" {} -r<ip> SessionService patch {{A: B,C: D,...}} # patch the json-formated {{prop: value...}} data to the sessionService object".format(rft.program))
