...
class RfAccountServiceMain():
    ...
    def displayOperations(self,rft):
        ...
        print("                               -- <roleId>:{Admin | Operator | ReadOnlyUser | <a custom roleId}, dflt=Operator")
...
class RfAccountServiceOperations():
    ...
    def examples(self,sc,op,rft,cmdTop=False,prop=None):
        ...
        print(" {} -r<ip> AccountService Roles   -iAdmin          # gets the Roles member with RoleId=Admin".format(rft.program))
        print(" {} -r<ip> AccountService adduser john 12345 Admin # add new user (john) w/ passwd \"12345\" and role: Admin".format(rft.program))
